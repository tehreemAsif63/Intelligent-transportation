...
- Jessie Johnsson:
- Tehreen Asif: Tehreem Asif made substantial contributions to both the Android application and the Arduino code. Her primary focus was on implementing the normal traffic light system, including defining the traffic light sequence and developing the necessary logic for the app. She also played a crucial role in helping with the implementation of the adaptive traffic light system, building upon the foundational concepts of the normal traffic light. Furthermore, Tehreem contributed to the development of the car finding function, which involved writing the necessary code and integrating it into the Android app through a dedicated button. Her efforts extended beyond coding as she enhanced the visual appeal of the application's pages, making them more engaging and aesthetically pleasing. Additionally, Tehreem actively worked on establishing the car finding functionality through MQTT connection and was instrumental in fixing, updating, and proofreading the app's readme file. Her dedication was evident in creating a comprehensive user manual to guide users on how to use the application effectively.
- Elif Sayeed Yaqoud:
